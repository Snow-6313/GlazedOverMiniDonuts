...
(function () {
  ...
  var TRANSLATIONS = {
    ...
    en: {
      ...
      hero_desc:             'Fresh, made-to-order mini donuts fried in real beef tallow — no seed oils, no artificial colors. Just peace, love, and buckets full of joy. ✌️❤️🍩',
      hero_cta_menu:         '🍩 See Our Flavors',
      hero_cta_truck:        'Come Find Us',
      hero_badge_oils:       'No Seed Oils',
      hero_badge_ingredients:'Real Ingredients',
      hero_badge_mto:        'Made to Order',
      marquee_item1:         'Fried in Beef Tallow',
      marquee_item2:         'No Seed Oils',
      ...
      ingredients_body:     'Old-school donuts made with beef tallow, real ingredients, and no seed oils or artificial colors.',
      ingredients_cta:      'Our Story',
      chip_tallow:          'Beef Tallow Fried',
      chip_oils:            'Zero Seed Oils',
      ...
      footer_copy:        '© 2025 Glazed Over Mini Donuts. All rights reserved. Made with ❤️ in Phoenix, AZ.',
    ...
    es: {
      ...
      hero_desc:             'Donas mini frescas hechas al momento, fritas en sebo de res — sin aceites de semillas ni colorantes artificiales. Pura paz, amor y cubetas llenas de alegría. ✌️❤️🍩',
      hero_cta_menu:         '🍩 Ver Nuestros Sabores',
      hero_cta_truck:        'Encuéntranos',
      hero_badge_oils:       'Sin Aceites de Semillas',
      hero_badge_ingredients:'Ingredientes Reales',
      hero_badge_mto:        'Hecho al Momento',
      marquee_item1:         'Fritas en Sebo de Res',
      marquee_item2:         'Sin Aceites de Semillas',
      ...
      ingredients_body:     'Estamos devolviendo las donas a los buenos tiempos, cuando la calidad era lo primero y el sabor era el rey. Sin aceites de semillas: nuestras donas se fríen en sebo de res para ese sabor dorado e irresistible. Sin colorantes artificiales — solo ingredientes reales.',
      ingredients_cta:      'Nuestra Historia',
      chip_tallow:          'Fritas en Sebo de Res',
      chip_oils:            'Cero Aceites de Semillas',
      ...
      footer_copy:        '© 2025 Glazed Over Mini Donuts. Todos los derechos reservados. Hecho con ❤️ en Phoenix, AZ.',
      ...
      val1_desc:  'Fritas en sebo de res natural — no aceites de semillas',
      val2_title: 'SIN ACEITES',
      val2_desc:  'Cero canola, vegetales u otros aceites. Punto.',
